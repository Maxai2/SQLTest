...
Нумерация должна быть по порядку, вторая нумерация должна соответствовать колонкам в таблице, а названия колонок должны соответсвовать
данным в файле с данными.
*/

--2	N'Âÿ÷åñëàâ'	N'Çåçèê'	3
